...
class JoinTherapistBottomSheet extends StatefulWidget {
  const JoinTherapistBottomSheet({super.key});

  @override
  State<JoinTherapistBottomSheet> createState() => _JoinTherapistBottomSheetState();
}

class _JoinTherapistBottomSheetState extends BaseState<JoinTherapistBottomSheet> {
  Timer? _debounce;
